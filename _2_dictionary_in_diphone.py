...
parser.add_argument('-i', '--input', default=f'_1_dictionary_seperate_dash.txt', required=False, type=str,
                    help='test in')
parser.add_argument('-o', '--output', default=f'_2_dictionary_in_diphone.txt', required=False, type=str,
                    help='test out')
